...
description: "Retrieves a Usuario record by email, including the BCrypt password hash. Intended exclusively for internal use by msvc-auth. Returns 404 when the email is not found."
---
...
<ResponseField name="password" type="string">
  The BCrypt-encoded password hash (e.g. `$2a$10$...`). Present **only** in this endpoint's response — all other endpoints omit this field.
</ResponseField>
