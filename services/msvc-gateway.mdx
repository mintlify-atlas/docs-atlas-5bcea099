---
title: "msvc-gateway: Spring Cloud API Gateway (Port 8090)"
sidebarTitle: "msvc-gateway"
description: "Spring Cloud Gateway MVC service on port 8090. Routes /api/usuarios/** and /api/cursos/** to backend services using Kubernetes client-side load balancing."
---
