---
title: "msvc-auth: OAuth2 Authorization Server"
sidebarTitle: "msvc-auth"
description: "Spring Authorization Server issuing JWT tokens on port 9000. Supports Authorization Code, OIDC 1.0, and refresh tokens. Delegates user lookup to msvc-usuarios."
---
...
| `LB_USUARIOS_URI` | Base URL used by the `WebClient` bean to reach `msvc-usuarios` | `http://msvc-usuarios:8001` |
