---
title: "OAuth2 Authorization Code Flow and JWT Token Issuance"
sidebarTitle: "OAuth2 Overview"
description: "msvc-auth issues JWTs via the Authorization Code grant with refresh token support, RSA 2048-bit signing, and openid, read, and write scopes."
---
