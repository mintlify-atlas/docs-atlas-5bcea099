---
title: "msvc-cursos: Course Management Service (Port 8002)"
...
`msvc-cursos` uses **Spring Cloud OpenFeign** to communicate with `msvc-usuarios`. The Feign client resolves the target service name via Spring Cloud Kubernetes discovery.
