---
title: "Get Started with Spring Cloud Microservices"
sidebarTitle: "Quickstart"
description: "Run the full microservices stack locally with Docker Compose, verify service health endpoints, and learn where to go next for the complete OAuth2 flow on Kubernetes."
---
...
<Steps>
  ...
  <Step title="Start databases only (development mode)">
    ...
    - **PostgreSQL 14** on `localhost:5532` with database `msvc_cursos`, user `postgres`, and password `postgres123`
