---
title: "DELETE /eliminar-usuario/{cursoId} — Unenroll User from Course"
...
<ResponseField name="mensaje" type="string">
  Error message prefixed with `"No se pudo eliminar el usuarioo error en la comunicacion: "` followed by the Feign exception message.
</ResponseField>
