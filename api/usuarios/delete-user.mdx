...
description: "Permanently removes a Usuario by ID. Triggers a Feign call to msvc-cursos to delete all course enrollments for the user. Requires the OAuth2 write scope."
---
